...
<html>
	...
	<body>
		<main>
		<h1>Cadastre um novo vendedor: </h1>
			<form method="post" action="vendedor_inclusao.php">
            ...
            <?php
				...
				echo"<input type='text' id='Horario' name='HORARIO' />";
				...
				echo"<input type='text' id='Nascimento' name='NASCISMENTO' />";
